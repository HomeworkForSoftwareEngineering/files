<?php include 'youtube_filesLogic.php'; ?>
...
<select class="deneme" id="uploaddersid" name="uploaddersname" >
...
<div class="deneme2">
    ...
    <input type="text" name="url">
      ...
      <button class="button" type="submit" value="submit"  name="submit" style="vertical-align:middle"><span>Upload </span></button>
